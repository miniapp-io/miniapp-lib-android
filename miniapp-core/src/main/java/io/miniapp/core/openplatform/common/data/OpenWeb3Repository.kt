...
internal class OpenWeb3Repository private constructor(): IOpenWeb3DataSource {

    companion object {
        private val _instance = OpenWeb3Repository()
        fun getInstance(): IOpenWeb3DataSource = _instance
    }

    private val remoteDataSource by lazy {
        OpenWeb3RemoteDataSource(OpenPlatformPluginImpl.getInstance().sessionProvider)
    }
