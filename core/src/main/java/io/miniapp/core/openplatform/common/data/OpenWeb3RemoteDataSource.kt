...
import io.miniapp.core.openplatform.common.apis.OpenWeb3Api
...
internal class OpenWeb3RemoteDataSource(provider: ()-> SessionProvider?) : IOpenWeb3DataSource {

    private val minAppApi = OkHttpClientProvider.retrofitFactory(provider).create(OpenWeb3Api::class.java)
