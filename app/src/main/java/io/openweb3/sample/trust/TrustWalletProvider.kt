package io.openweb3.sample.trust
...
class TrustWalletProvider : BridgeProvider {
    ...
    private fun initBridge(context: Context) {
        val provderJs = loadProviderJs(context)
...
//        }
    ...
    private fun loadProviderJs(context: Context): String {
